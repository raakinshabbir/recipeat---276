...
document.addEventListener("turbo:load", function () {
  ...
  if (swiperContainer) {
    ...
    const blankSlideAdded = swiperContainer.getAttribute('data-blank-slide-added');
    console.log(blankSlideAdded)
    if (!blankSlideAdded) {
      const blankSlide = document.createElement('swiper-slide');
      blankSlide.style.cssText = "padding: 60px; border: 3px solid #ccc; border-radius: 16px; background-color: #f9f9f9;";
      swiper.appendSlide(blankSlide); // Prepend blank slide to the swiper

      // Mark that the blank slide has been added
      swiperContainer.setAttribute('data-blank-slide-added', 'true');
    }
