...
document.addEventListener("turbo:render", function () {
  ...
  // Ensure swiperContainer exists and initialize only if not already initialized
  if (swiperContainer && !swiperContainer.swiper) {
    ...
    // Handle swiper slides initialization
    let lastSeenIndex = 0;
    let loading = false;
    ...
    // Listener for swiper slide change to handle like/dislike overlay
